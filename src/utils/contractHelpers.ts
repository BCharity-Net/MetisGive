...
import {
  ...
  getGiveAddress,
  getVaultChefAddress,
  getStakingRewardsAddress,
  getMVaultChefAddress,
...
import mVaultChefAbi from 'config/abi/mVaultChef.json'
...
import sushiMiniChef from 'config/abi/sushiMiniChef.json'
...
//   // const gasPrice = account ? getSettings(account).gasPrice : 20000 // DEFAULT_GAS_PRICE
...
export const getMVaultChefContract = (web3?: Web3) => {
  return getContract(mVaultChefAbi, getMVaultChefAddress(), web3)
}

// sushi chef mini chef contract
export const getSushiMiniChefContract = (web3?: Web3) => {
  return getContract(sushiMiniChef, getSushiMiniChefContract(), web3)
}
...
export const getQuickRewardVaultContract = (web3?: Web3) => {
  return getContract(stakingRewardsAbi, getStakingRewardsAddress(), web3)
}
