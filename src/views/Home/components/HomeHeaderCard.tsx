...
const HomeHeaderCard = () => {
  ...
  const subtitle = 'Better transparency for charities with blockchain.'
  ...
  return (
    <StyledHeadingCard>
      ...
      <Title>{t(title)}</Title>
      <a href="https://metisgive.gitbook.io/metisgive/" target="_blank" rel="noreferrer">
        <LearnMoreButton>{t('Learn More...')}</LearnMoreButton>
      </a>
