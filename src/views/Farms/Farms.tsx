...
const Farms: React.FC = () => {
  ...
  // const viewMode = cakePrice.toString() === '' ? ViewMode.TABLE : ViewMode.CARD
  ...
  const activeFarms = farmsLP.filter(
    (farm) => !farm.isSingleToken && !farm.isHiddenFarm && farm.multiplier !== '0X' && !isArchivedPid(farm.pid),
  )
  ...
  const farmsList = useCallback(
    (farmsToDisplay: Farm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        // let pngPrice = 0
        // if (farm.pid === 6) {
        //   pngPrice = new BigNumber(farm.token.busdPrice).toNumber()
        // }
        const totalLiquidity = new BigNumber(farm.lpTotalInQuoteToken).times(farm.quoteToken.busdPrice)
        // let totalLiquidity =
        //   farm.pid === 5
        //     ? new BigNumber(farm.lpTotalInQuoteToken).times(pngPrice)
        ...
        //   alert(
        //     'pid: '
        //       .concat(farm.pid.toString())
        //       .concat('\n lpTotalInQuoteToken: ')
        //       .concat(farm.lpTotalInQuoteToken.toString())
        //       .concat('\n busdPrice: ')
        //       .concat(farm.quoteToken.busdPrice.toString())
        //       .concat('\n totalLiquidity: ')
        //       .concat(totalLiquidity.toString())
        //       .concat('\n poolWeight: ')
        //       .concat(farm.poolWeight.toString())
        //       .concat('\n cakePrice: ')
        //       .concat(cakePrice.toString()),
        //   )
        // }
        // if (farm.pid === 5) {
        // console.log(apr)
        // console.log(new BigNumber(farm.poolWeight).toNumber())
        // console.log(cakePrice.toNumber())
        // console.log(new BigNumber(farm.lpTotalInQuoteToken).toNumber())
        // console.log(new BigNumber(farm.quoteToken.busdPrice).toNumber())
  ...
  const rowData = farmsStakedMemoized.map((farm) => {
    ...
    const lpLabel = farm.lpSymbol && farm.lpSymbol.split(' ')[0].toUpperCase().replace('GIVE', '')
      ...
      <Page>
        <ControlContainer>
          <ViewControls>
            ...
            {/* hide archived farms tab for now */}
