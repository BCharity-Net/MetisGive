...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, account }) => {
  ...
  // const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('GIVE', '')
  ...
  if (farm.swapPlatform === 'MoonSwap') {
    ...
    addLiquidityUrl = `https://exchange.dfyn.network/#/add/${liquidityUrlPathParts}`
  } else if (farm.swapPlatform === 'Pangolin') {
    addLiquidityUrl = `https://app.pangolin.exchange/#/add/${liquidityUrlPathParts}`
  } else if (farm.swapPlatform === 'GiveSwap') {
    addLiquidityUrl = `https://bcharity-net.github.io/GiveSwap/#/add/${liquidityUrlPathParts}`
  } 
  
  // const addLiquidityUrl = https://quickswap.exchange/#/add/${liquidityUrlPathParts}`
