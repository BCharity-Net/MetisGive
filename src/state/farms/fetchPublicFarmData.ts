...
const fetchFarm = async (farm: Farm): Promise<PublicFarmData> => {
  ...
  const tokenAmountMc = farm.isSingleToken
    ? new BigNumber(lpTokenBalanceMC).div(BIG_TEN.pow(tokenDecimals))
  ...
  // if (pid === 0) {
  //   console.log("depositfee".concat(info.depositFeeBP))
  //   console.log("totalallocpoint".concat(totalAllocPoint))
  //   console.log("giveperblock".concat(givePerBlock))
  // }
  return {
