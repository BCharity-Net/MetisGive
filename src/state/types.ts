...
import { CampaignType, FarmConfig, ReferralConfig, Nft, PoolConfig, Team, VaultConfig } from 'config/constants/types'
...
export interface Vault extends VaultConfig {
  ...
  sushiData?: {
    // set of variables used to calculate apr for vaults that use the SushiSwap Strategy
