...
import {
  ...
  getGiveContract, getVaultChefContract, getMVaultChefContract,
...
export const useVaultchef = () => {
  const web3 = useWeb3()
  return useMemo(() => getVaultChefContract(web3), [web3])
}
export const useMVaultchef = () => {
  const web3 = useWeb3()
  return useMemo(() => getMVaultChefContract(web3), [web3])
}
